...
public class ContractDAO {
    ...
    public static ContractDTO getContractDetail(String id) {
        ...
        try {
            ...
            if (rs.next()) {
                        contract = new ContractDTO(rs.getInt(1), rs.getInt(2), rs.getInt(3), rs.getString(4), rs.getInt(5), rs.getString(6), BigDecimal.valueOf(rs.getDouble(7)), BigDecimal.valueOf(rs.getDouble(8)), rs.getDate(9), rs.getDate(10), rs.getString(11), rs.getString(12), rs.getInt(13));
            }
            cn.close();
