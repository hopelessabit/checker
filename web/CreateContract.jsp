                ...
                <c:set var="RoIDs" value="${RoomDAO.getRoomID(OID)}"></c:set>
                    ...
                    <div class="card">
                        <div class="card-body mx-md-12">
                            ...
                            <div style="margin-left: 20%;" class="row mb-3">
                                <label for="inputPassword" class="col-sm-2 col-form-label">System fee</label>
                                <div class="col-sm-10">
                                    <input type="text" name="systemFee" value="${requestScope.systemFee}" readonly/>
                                </div>
                            </div>
                            ...
                            <c:if test="${requestScope.cstatus != 1}">
                                <div style="margin-left: 20%;" class="row mb-3">
                                    <label class="col-sm-2 col-form-label">Calculate system fee</label>
                                    <div class="col-sm-10">
                                        <button type="submit" name="action" value="Calculate system fee" class="btn btn-primary" style="width: 50%; height: 50px" >Calculate system fee</button>
                                    </div>
                                </div>
                            </c:if>
                            <c:if test="${requestScope.cstatus == 1}">
                        ...
                        <h3 style="yellow"> ${requestScope.creditNoti} </h3>
                        <script>
