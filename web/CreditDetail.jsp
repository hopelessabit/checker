        ...
        <main id="main" class="main">
            ...
            <div class="card">
                <div class="card-body mx-md-12">
                    <h5 class="card-title text-center">ADD CREDIT TO YOUR BALANCE</h5>
                    <h3 align="center" style="color:green">Your credit: ${sessionScope.user.getCredit()}</h3>
                    <br>
                    <form class="row g-3" action="MainController" method="post" >
                        <div style="margin-left: 38%;">
                        <div class="col-lg-3">
                                
                            <input class="form-control" type="text" name="money" placeholder="Enter Credit"/></div>
                            <br>
                            <div class="col-lg-3">
                            <input class="btn form-control btn-primary" type="submit" name="action" value="Checkout"/>
            ...
            <!-- ======= Footer ======= -->
            <footer style="margin-top: 30%" id="footer" class="footer">
                <div class="copyright">
