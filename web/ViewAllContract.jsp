...
<html>
  ...
  <nav class="header-nav ms-auto">
        ...
        <main id="main" class="main">
            ...
            <div class="pagetitle">
                <h1>ALL CONTRACT ON SERVER</h1>
                <nav>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="MainController?action=getInfo">Home</a></li>
                        <li class="breadcrumb-item">All contract on server</li>
            ...
            <form class="row" action="MainController" method="post">
                ...
                <div class="col-lg-2">
                    ...
                    <input class="btn form-control btn-primary" type="submit" value="Search Contract"/></div>
            </form><br>
