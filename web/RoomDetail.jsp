        ...
        <main id="main" class="main">
            ...
            <div class="pagetitle">
                ...
                <nav>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Add Room Image</li>
                    </ol>
                </nav>
            </div><!-- End Page Title -->
            <!------------------------------------------------------ Start Main ---------------------------------------------------->
            ...
            <section class="section dashboard">
                ...
                <div class="row">
                    ...
                    <script>
  const selectRoID = document.querySelector('select[name="RoID"]');

// Lưu trữ giá trị RoID khi có sự thay đổi của select
selectRoID.addEventListener('change', function() {
  localStorage.setItem('RoID', selectRoID.value);
});

// Kiểm tra và gán lại giá trị RoID vào select khi trang được load lại
const savedRoID = localStorage.getItem('RoID');
if (savedRoID) {
  selectRoID.value = savedRoID;
}
</script>
                    <div class="col-md-5">
